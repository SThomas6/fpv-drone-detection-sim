...
for t in data/clips/range_tele data/clips/range_tele_wide data/clips/range_1km_hr; do
...
capture range_tele      "$W/detection_world_terrain_tele.sdf" telesweep 0.5    300 0.10472 61 4 611
capture range_tele_wide "$W/detection_world_terrain_far.sdf"  telesweep 0.5    300 1.047   61 4 611
capture range_1km_hr    "$W/detection_world_terrain_far.sdf"  longsweep 0.0667 300 1.047   51 4 411
